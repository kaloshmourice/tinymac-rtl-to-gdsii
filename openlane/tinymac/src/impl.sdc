#============================================================
# TinyMAC Implementation SDC
# Description:
#   Timing constraints used during implementation.
#============================================================
...
if { [info exists ::env(CLOCK_PORT)] } {
    ...
    if { $port_count == "0" } {
        ...
        puts "\[WARNING] Multi-clock files are not currently supported. Only the first clock will be constrained."
    }
