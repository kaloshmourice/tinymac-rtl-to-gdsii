...
# TinyMAC Signoff SDC
# Description:
#   Timing constraints used during final signoff checks.
#============================================================
...
if { [info exists ::env(CLOCK_PORT)] } {
    ...
    if { $port_count == "0" } {
        ...
        puts stderr "\[WARNING] Multi-clock files are not currently supported. Only the first clock will be constrained."
    }
